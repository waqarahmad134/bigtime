    ...
    <div className="space-y-6 text-[white]">
      ...
      <div className="bg-[#1F1339] rounded-xl p-6 shadow-lg ">
        ...
        <div className="flex gap-4 mb-4">
          <button className="bg-purple-700 px-4 py-2 rounded-md text-sm">
            Edit Profile
          </button>
          <button className="bg-gray-700 px-4 py-2 rounded-md text-sm">
            Share Profile
          </button>
          <button className="bg-gray-700 px-4 py-2 rounded-md text-sm">
            Add Friend
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-[#2C2153] p-4 rounded-md text-center">
            Quick Match
          </div>
          <div className="bg-[#2C2153] p-4 rounded-md text-center">
            Join Guild
