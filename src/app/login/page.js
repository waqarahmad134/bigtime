  ...
  return (
    <div className="relative min-h-screen flex">
      ...
      <div className="font-bold w-1/2 flex flex-col justify-center px-16 md:flex">
        ...
        <h1 className="font-bebas-neue font-medium text-[96px] text-white leading-tight">
          BIG TIME
        </h1>
        <div className="font-poppins leading-none">
          <p className="text-[25px] md:text-[40px] text-white uppercase">
            Sign in to your
          </p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="pl-11 bg-[#190733] text-white py-3 w-full rounded-xl theme-inner-shadow placeholder-gray-400 border-none focus:ring-2 focus:ring-violet-500"
                />
              </div>
            </div>

            <button
              className="w-full py-3 bg-[#3B2063] text-white rounded-xl uppercase tracking-wide transition-all duration-300 transform hover:scale-105 cursor-pointer"
              onClick={handleLogin}
            >
              Login
            </button>
