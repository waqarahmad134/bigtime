    ...
    <div className="relative px-10 py-10  items-center">
      ...
      <div className="max-w-5xl m-auto">
        <div className="w-full relative">
          ...
          <div className="bg-gradient-to-r from-[#1f093a] to-[#1f093a] border border-[#7A59FF] drop-shadow-[0_4px_6px_rgba(255,215,0,0.3)] rounded-lg p-8 text-center shadow-lg">
        ...
        <main className="text-white my-10">
          <div className="mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 flex flex-col space-y-4 ">
              ...
              <div className="bg-gradient-to-r from-[#1A0B2EE5] to-[#16213EE5] rounded-xl p-6 border border-purple-700">
            ...
            <div className="flex flex-col space-y-6">
              {/* Pricing */}
              <div className="bg-gradient-to-b from-[#22153E] to-[#321C55] rounded-xl p-6">
              ...
              <div className="bg-transparent border border-purple-700 rounded-xl p-6">
          ...
          <div className="w-full bg-gradient-to-r from-[#1A0B2EE5] to-[#533A71E5] border border-purple-700 rounded-xl p-4 sm:p-6 mt-5">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-center">
                <button className="flex justify-center items-center gap-3 bg-[#2E0B48] rounded-lg text-white py-2 px-10">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
